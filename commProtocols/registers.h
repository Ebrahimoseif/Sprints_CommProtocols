...
#define ADCH			*((reg_type8_t)0X25)
#define ADCL			*((reg_type8_t)0X24)

/*
 * I2C Registers
 */

#define TWDR			 *((reg_type8_t)0X23)
#define TWAR			 *((reg_type8_t)0X22)
#define TWSR			 *((reg_type8_t)0X21)
#define TWBR			 *((reg_type8_t)0X20)
